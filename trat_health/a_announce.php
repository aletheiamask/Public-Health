...
$sql = "SELECT * FROM posts_forum WHERE main_category = 'ประกาศ'";
$conditions = [];
              ...
              <ul class="nav nav-pills py-4 ">
                ...
                <div class="nav-item"><button class="nav-link btn-secondary dropdown-toggle  active" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-current="page">
                  ...
                  <ul class="dropdown-menu  "> 
                    <li><a class="dropdown-item nav-link active" href="a_announce.php">ประกาศ</a></li>
...
<div style="display: flex;">
      ...
      <form role="search" method="GET" action="./a_announce.php" style="display: flex;">
